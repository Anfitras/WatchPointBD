...
<body>
  <main>
    ...
    <form action="cadastro_obras_BD.php" method="POST">
      ...
      <input type="text" id="url_poster" name="url_poster" required /><br /><br />

      <label for="sinopse">Sinopse:</label>
      <textarea id="sinopse" name="sinopse" rows="4" cols="50" required></textarea><br /><br />
      ...
      <fieldset>
        ...
        <?php endforeach; ?>
        <?php if (empty($generos_disponiveis)): ?>
          <p>Nenhum gênero encontrado. Cadastre gêneros primeiro.</p>
        <?php endif; ?>
      </fieldset>
      <br />
